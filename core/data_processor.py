...
class DataLoad:
    ...
    def __init__(self, dirpath, split: float):
        ...
        self.in_trans = transforms.Compose([transforms.CenterCrop(512), transforms.Resize(256), transforms.ToTensor()])
        self.out_trans = transforms.Compose([transforms.CenterCrop(512), transforms.ToTensor()])
